...
| `battery_capacity_kwh`      | FLOAT(10,6)       | Maximum energy storage of the vehicle's battery in kilowatt-hours (e.g., `108.4630074`).        |
...
| `energy_consumed_kwh`       | FLOAT(10,6)       | Total energy consumed during the charging session, in kilowatt-hours (e.g., `60.71234573`).     |
| `charging_duration_hours`   | FLOAT(10,6)       | Total time taken to charge the vehicle, in hours (e.g., `0.591363425`).                         |
| `charging_rate_kw`          | FLOAT(10,6)       | Average power delivery rate during the session, in kilowatts (e.g., `36.38918057`).             |
| `charging_cost_usd`         | FLOAT(10,6)       | Total cost of the charging session in US dollars (e.g., `13.08771679`).                         |
...
| `state_of_charge_start`     | FLOAT(10,6)       | Battery percentage at the start of charging (e.g., `29.37157598`).                              |
| `state_of_charge_end`       | FLOAT(10,6)       | Battery percentage at the end of charging (e.g., `86.11996244`).                                |
| `distance_driven`           | FLOAT(10,6)       | Distance traveled since the last charge, in kilometers (e.g., `293.6021106`).                   |
| `temperature`               | FLOAT(10,6)       | Ambient temperature during the session, in degrees Celsius (e.g., `27.94795306`).              |
